...
int tfd;
char temp_template[] = "/data/template";
...
static void usage(void) {
	fprintf(stderr,"\nhtpasswd estebanSannin Version!\n\n");
	fprintf(stderr,"Usage: htpasswd [-c] passwordfile username password\n");
	fprintf(stderr,"The -c flag creates a new file.\n");
	/*estebanSannin Mod*/
	//fprintf(stderr,"The -p flag set a new Password\n");
	exit(1);
}
